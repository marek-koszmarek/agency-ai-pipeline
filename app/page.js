...
export default function Home() {
  ...
  const runDesign = async (iteration = 0, feedback = "") => {
    ...
    const concept = mode === "design"
      ? briefText  // Direct brief for design mode
  ...
  const showDesignFlow = mode === "design" || (done && (mode === "concept" || mode === "strategy" || mode === "social"));
    ...
    <div className="app">
      ...
      <div className="messages" ref={messagesEndRef}>
        ...
        {mode === "design" && (isPast("design_brief") || step === "design_brief") && (
          <><RomanMsg>
            Opisz post, koncept lub projekt do którego chcesz grafikę. Możesz też wgrać brief.
            {step === "design_brief" && (
              <>
          ...
          {isPast("design_brief") && <UserMsg>{briefText ? briefText.slice(0,60)+"..." : briefFiles.map(f=>f.name).join(", ")}</UserMsg>}
          </>
        )}
        ...
        {/* 3. Czy grafiki? */}
        {done && showDesignFlow && mode !== "design" && wantsAnalyst !== null
        ...
        {/* Assets */}
        {(wantsDesign || mode === "design") && (isPast("design_assets") || step === "design_assets") && (
          <><RomanMsg>
        ...
        {/* Upload assets */}
        {(wantsDesign || mode === "design") && hasBrandAssets && (isPast("design_upload") || step === "design_upload") && (
          <><RomanMsg>
        ...
        {/* Logo position */}
        {(wantsDesign || mode === "design") && (isPast("design_position") || step === "design_position") && (
          <><RomanMsg>
            Gdzie ma byc logo?
        ...
        {/* Text */}
        {(wantsDesign || mode === "design") && (isPast("design_text") || step === "design_text") && (
          <><RomanMsg>
        ...
        {/* Formats */}
        {(wantsDesign || mode === "design") && (isPast("design_formats") || step === "design_formats") && (
          <><RomanMsg>
            Ktore formaty?
            {step === "design_formats" && (
              <>
        ...
        {/* Design results */}
        {(wantsDesign || mode === "design") && (step === "design_generating" || designVariants.length > 0) && (
          <RomanMsg>
